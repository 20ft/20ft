...
There's no orchestrator, no DSL and no guessing about what's going on. 20ft is directly commanded, starting with a simple command line client; which for additional control can customised by implementing a Python function; and ultimately we are able to use 20ft's fully OO SDK to produce standalone dynamic container applications.
